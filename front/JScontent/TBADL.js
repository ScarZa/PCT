function TBADL(content, id = null) {

    var title = " ผลการประเมินความสามารถในการประกอบกิจวัตรประจำวัน (ADL)";
    ...
    $("#Ssubmenu8-2").parent().find("li:eq(1)").addClass("active")
    ...
    CTb.GetNewTableAjax('contentTB','../back/API/DT_ADL.php','../back/API/tempSendDataAPI.php',column1
    ,null,null,null,null,false,false,null,false,null,true,'../front/content/ADL_graph.html',null,null,null,null,'dynamic-table');

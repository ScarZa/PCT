function TBreportDC(content, id = null) {
  $.cookie("dep", "");
  ...
  console.log(id.data);
  console.log($.cookie("year-clinic"));
  ...
  CTb.GetNewTableAjax('contentTB','../back/API/DT_detialIPDcase.php?'+id.data+'?'+$.cookie("year-clinic"),'../back/API/tempSendDataAPI.php',column1

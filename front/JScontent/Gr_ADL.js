function GrADL(content, id = null) {
    var title = " ผลการประเมิน ADL";
    var subtitle = "";
    var PL = new PageLayout(content);
        ...
        var title1 = "ผลการประเมิน ADL";
        var subtitle = "รายครั้ง";
        var unit = "คะแนน";
        $.getJSON('../../back/API/graph_ADL.php',{data:$.cookie('hn')},function (data) { console.log(data)
            var date = data.date
            var CChartsP =  new AJAXCharts('contentGr','line',title1,unit,date,'../../back/API/DC_columnADL.php?'+$.cookie('hn'),subtitle,['#3ec613', '#cc6945', '#6c94dd', 'purple', '#d92727', 'orange', 'yellow']);
            $(CChartsP.GetCL());
        });     

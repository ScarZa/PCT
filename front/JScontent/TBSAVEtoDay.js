function TBSAVEtoDay(content, id = null) {
  ...
  $('#head-table').empty().append('ผู้ป่วยที่ต้องประเมิน SAVE ')
    ...
    CTb.GetNewTableAjax('contentGr','../back/API/DT_SAVE3.php?'+$.cookie("ward"),'../back/API/tempSendDataAPI.php',column1
    ...
    CTb2.GetNewTableAjax('contentTB','../back/API/DT_SAVE7.php?'+$.cookie("ward"),'../back/API/tempSendDataAPI.php',column1

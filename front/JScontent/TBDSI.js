function TBDSI(content, id = null) {

    var title = " ผลการประเมินกระตุ้นพัฒนาการ (DSI 300)";
    ...
    CTb.GetNewTableAjax('contentTB','../back/API/DT_DSI.php','../back/API/tempSendDataAPI.php',column1
    ,null,null,null,null,false,false,null,false,null,true,'../front/content/DSI_graph.html',null,null,null,null,'dynamic-table');

function IPDConsult(content, id = null) {
    ...
    //$("#submenu1").parent().find("li:eq(0)").addClass("active")
        ...
        +"<br>ที่อยู่ : "+data[0].informaddr+"<br>โทรศัพท์ : "+data[0].tel0+" "+data[0].tel1+" "+data[0].tel2+"<br>วันเกิด : "+data[0].birthday+" อายุ : "+data[0].age_y+" ปี "+data[0].age_m+" เดือน สถานะภาพ : "+data[0].mrname+"<br>การวินิจฉัย : "+data[0].pdx+" "+data[0].dx0
        ...
        patient_photo('','../',data[0].hn,data[0].an,'#pics-panel');
            if ($.cookie("dep") == '005') {
                $("#P-data").append($("<br><div class='row'><div class='col-lg-12'><a href='' id='progress-not' class='btn btn-success'><i class='fa fa-pencil-square-o'></i> Progress note</a></div></div>"))
    }   

function TBFoodRegis(content, id = null) {
    $.cookie("dep", "024");
    var title = " งานโภชนาการ";
    var subtitle = "ตารางงานโภชนาการ ";
    ...
    $("#submenu9").parent().find("li:eq(0)").addClass("active")
    ...
    CTb.GetNewTableAjax('contentTB','../back/API/DT_FoodR.php?','../back/API/tempSendDataAPI.php',column1

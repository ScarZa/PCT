function GrDepress(content, id = null) {
    ...
    var subtitle = "";
        ...
        $.getJSON('../back/API/graph_9Q.php',{data:$.cookie('hn')},function (data) { console.log(data)
            var date = data.date
            var CChartsP =  new AJAXCharts('contentGr','line',title1,unit,date,'../back/API/DC_column9Q.php?'+$.cookie('hn'),subtitle,['#3ec613', '#cc6945', '#6c94dd', 'purple', '#d92727', 'orange', 'yellow']);
            $(CChartsP.GetCL());
        });     

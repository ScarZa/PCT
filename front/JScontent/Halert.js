function HAlert(content, id = null) {
    $(content).empty().append($("<div class='col-lg-12 alert alert-danger'><div class='row' id='dangrow-1'></div><div class='row' id='dangrow-2'></div></div>")
                            , $("<div class='col-lg-12 alert alert-info'><div class='row' id='inforow-1'></div></div><p>")
    );
    $("#dangrow-1").empty().append($(" <div class='col-lg-2'><a id='suiside-panel' href='#' class='btn btn-pink btn-block' title='กดเพื่อดูรายละเอียด'><img src='images/suiside.png' height='55'> ป้องกันฆ่าตัวตาย <span class='badge badge-warning'><b id='suiside' style='font-size:275%;'> 0 </b></span></a></div> ")
    ...
    $("#dangrow-2").empty().append($(" <div class='col-lg-2'><a id='drug-panel' href='#' class='btn btn-info btn-block' title='กดเพื่อดูรายละเอียด'><img src='images/drug.png' height='55'> High Alert Drug <span class='badge badge-warning'><b id='drug' style='font-size:275%;color:white;'> 0 </b></span></a></div> ")
    )
    $("#inforow-1").empty().append($(" <div class='col-lg-2'><span id='total-admit'></span></div"))

function TBLithium(content, id = null) {
    $.cookie("dep", "018");
    var title = " งานเภสัชกรรม";
    var subtitle = "ตารางผู้รับการประเมินยา Lithium Carbonate ";
  ...
  $("#Ssubmenu5-1").parent().find("li:eq(1)").addClass("active");
  ...
  $("h5#head-table").empty().append("<i class='ace-icon fa fa-table'></i> " + subtitle);
    ...
    CTb.GetNewTableAjax('contentTB','../back/API/DT_Lithium.php?','../back/API/tempSendDataAPI.php',column1
    ,null,null,null,null,false,false,null,false,null,true,'content/Lithium_detial.html',null,null,null,null,'dynamic-table');
}

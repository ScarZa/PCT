function CohortDis(content, id = null) {
  $(content).empty().append("<div class='row'><div class='col-lg-12'>"
    ...
    + "<div class= 'col-lg-12' id='row2' align='center'><a href='#' id='showTBcohort'>กดเพื่อแสดง ตารางข้อมูลผู้ป่วยใน Cohort ward <img src='images/click.gif' width='75'></a></div></div></div> ");
  ...
  $("#cohD2").prepend("<div class='row'><div class='col-xs-12 col-sm-12 widget-container-col'>"
    ...
    + "<option data-class='default' value='#EEE'>#EEE</option>"
    + "</select></div></div>"
    + "<div class='widget-body'><div class='widget-main no-padding'></div><div align='center' id='sel-div'></div><div class='row'><div class= 'col-lg-12' id='cohD2_1'></div><div class= 'col-lg-12' id='cohD2_2' align='center'><a href='#' id='showRefer'>กดเพื่อดู ข้อมูลโรงพยบาล Refer มาที่ Cohort Ward <img src='images/click.gif' width='75'></a></div></div>"
    + "</div></div></div></div>");
...
//   })
  ...
  var subtitle3 = "แยกโรงพยาบาล";
      var unit = "คน";
  $.getJSON('../back/API/graph_DOM.php', { data1: monthint, data2: year }, function (data) {
    var date = data.day;
    var CChartsCh = new AJAXCharts('cohD2_1', 'line', title1, unit, date, '../back/API/DC_columnCohort.php?' + monthint + '?' + year, subtitle, ['#04c20d', '#c99138', '#6c94dd', 'purple', '#d92727', 'orange', 'yellow']);
    $(CChartsCh.GetCL());
    $("a#showRefer").click(function () {
      ...
      var CChartsChr = new AJAXCharts('cohD2_2', 'line', title2, unit, date, '../back/API/DC_columnCohort_refer.php?' + monthint + '?' + year, subtitle, ['#04c20d', '#c99138', '#6c94dd', 'purple', '#d92727', 'orange', '#CDBB06', '#6F6866', '#581845', '#0055C1', '#00B8C1', '#cc6945', '#CD00A1', '#065E82']);
      $(CChartsChr.GetCL());
    });
  });
  ...
  $("a#showTBcohort").click(function () {
    ...
    CTb.GetNewTableAjax('row2', '../back/API/DT_cohort.php?' + monthint + '?' + year, '../back/API/tempSendDataAPI.php', column1
  ...
  $("select#sel-month").change(function () {
    ...
    $.getJSON('../back/API/graph_DOM.php', { data1: monthint, data2: year }, function (data) {
      var date = data.day;
      var CChartsCh = new AJAXCharts('cohD2_1', 'line', title1, unit, date, '../back/API/DC_columnCohort.php?' + $("select#sel-month").val() + '?' + yearval, subtitle, ['#04c20d', '#c99138', '#6c94dd', 'purple', '#d92727', 'orange', 'yellow']);
      $(CChartsCh.GetCL());
      $("a#showRefer").click(function () {
        $("#cohD2_2").empty().html('<center><i class="fa fa-spinner fa-pulse" style="font-size:48px"></i><br><br> <h3>กำลังดำเนินการ.....</h3></center><br>');
        var CChartsChr = new AJAXCharts('cohD2_2', 'line', title2, unit, date, '../back/API/DC_columnCohort_refer.php?' + $("select#sel-month").val() + '?' + yearval, subtitle, ['#04c20d', '#c99138', '#6c94dd', 'purple', '#d92727', 'orange', '#CDBB06', '#6F6866', '#581845', '#0055C1', '#00B8C1', '#cc6945', '#CD00A1', '#065E82']);
        $(CChartsChr.GetCL());
      });
    });
    $("a#showTBcohort").click(function () {
      $("#row2").html('<center><i class="fa fa-spinner fa-pulse" style="font-size:48px"></i><br> <h3>กำลังดำเนินการ.....</h3></center><br>');
      CTb.GetNewTableAjax('row2', '../back/API/DT_cohort.php?' + $("select#sel-month").val() + '?' + yearval, '../back/API/tempSendDataAPI.php', column1
        , null, null, null, null, false, false, null, false, null, false, null, null, null, null, null, null);
    });
  });
  $("select#sel-year").change(function () {
    ...
    $.getJSON('../back/API/graph_DOM.php', { data1: monthint, data2: year }, function (data) {
      var date = data.day;
      var CChartsCh = new AJAXCharts('cohD2_1', 'line', title1, unit, date, '../back/API/DC_columnCohort.php?' + monthval + '?' + $("select#sel-year").val(), subtitle, ['#04c20d', '#c99138', '#6c94dd', 'purple', '#d92727', 'orange', 'yellow']);
      $(CChartsCh.GetCL());
      $("a#showRefer").click(function () {
        $("#cohD2_2").empty().html('<center><i class="fa fa-spinner fa-pulse" style="font-size:48px"></i><br><br> <h3>กำลังดำเนินการ.....</h3></center><br>');
        var CChartsChr = new AJAXCharts('cohD2_2', 'line', title2, unit, date, '../back/API/DC_columnCohort_refer.php?' + monthval + '?' + $("select#sel-year").val(), subtitle, ['#04c20d', '#c99138', '#6c94dd', 'purple', '#d92727', 'orange', '#CDBB06', '#6F6866', '#581845', '#0055C1', '#00B8C1', '#cc6945', '#CD00A1', '#065E82']);
        $(CChartsChr.GetCL());
      });
    }); $("a#showTBcohort").click(function () {
      $("#row2").html('<center><i class="fa fa-spinner fa-pulse" style="font-size:48px"></i><br> <h3>กำลังดำเนินการ.....</h3></center><br>');
      CTb.GetNewTableAjax('row2', '../back/API/DT_cohort.php?' + monthval + '?' + $("select#sel-year").val(), '../back/API/tempSendDataAPI.php', column1
        , null, null, null, null, false, false, null, false, null, false, null, null, null, null, null, null);
    });
  });
}

function CohortDis(content, id = null) {
  $(content).empty().append("<div class='row'><div class='col-lg-12'>"
    + "<div class= 'col-lg-6' id='cohD1'><div class= 'col-lg-12' id='cohD1_1'></div></div>"
  ...
  var title3 = "ข้อมูล Referin สะสมแยกโรงพยาบาล";
  var subtitle = "รายวัน";
  ...
  $.getJSON('../back/API/graph_District.php', function (data) { console.log(data)
          ...
          var CChartsD = new AJAXCharts('cohD1_1', 'column', title3, unit, hosname, '../back/API/DC_columnCohort_refer_collect.php', subtitle3, ['#068246', '#cc6945', '#6c94dd', 'purple', '#d92727', 'orange', '#CDBB06','#6F6866','#581845','#0055C1','#00B8C1','#A36300','#CD00A1','#065E82']);
          $(CChartsD.GetCL());
  });

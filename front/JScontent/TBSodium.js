function TBSodium(content, id = null) {
    $.cookie("dep", "018");
    var title = " งานเภสัชกรรม";
    var subtitle = "ตารางผู้รับการประเมินยา Sodium Valproate ";
  ...
  $("#Ssubmenu5-1").parent().find("li:eq(3)").addClass("active");
  ...
  $("h5#head-table").empty().append("<i class='ace-icon fa fa-table'></i> " + subtitle);
    ...
    CTb.GetNewTableAjax('contentTB','../back/API/DT_Sodium.php?','../back/API/tempSendDataAPI.php',column1
    ,null,null,null,null,false,false,null,false,null,true,'content/Sodium_detial.html',null,null,null,null,'dynamic-table');
}

var AssFirstRecIPD = function(content){
    ...
    this.GetFRIPD = function () {
        ...
        +"<span class='row' id='menses-div'></span>"
        ...
        +"<div class='col-sm-8'><input class='input-sm' type='text' id='narcotic_vol0' name='narcotic_vol[]' placeholder='จำนวน (ตัวเลข)' /></div></div>"
        ...
        +"<div class='col-sm-8'><input class='input-sm' type='text' id='narcotic_frequency0' name='narcotic_frequency[]' placeholder='' /></div></div>"
        +"</div></div>"
        +"<div class='col-lg-12 row'><div class='form-horizontal' role='form'>"
        ...
        +"<div class='col-sm-5'><input class='input-sm' type='text' id='narcotic_age0' name='narcotic_age[]' placeholder='' /></div></div>"
        ...
        +"<div class='col-sm-5'><input class='input-sm' type='text' id='last_useD0' name='last_useD[]' placeholder='ระบุจำนวนวัน' /></div></div>"
        +"</div></div>"
        +"<div class='col-lg-12 row'><div class='form-horizontal' role='form'>"
      ...
      + "</div></div>")
        ...
        +"<div class='form-group row'><div class='col-sm-3'><label><input class='ace' type='radio' name='typeP' value='1'><span class='lbl'> จิตเวชทั่วไป </span></label></div><div class='col-lg-2 col-sm-3'><label><input class='ace' type='radio' name='typeP' value='2'><span class='lbl'> พรบ.สุรา/ยาเสพติด</span></label></div>"
        + "</div></div>")
...
//////////////////////////// Part 1
        $("#part1").empty().append($("<div class=''><div class='block' id='pics'></div><span class='row'><h5><p>ชื่อผู้ป่วย : <b id='patient_name'></b> &nbsp;&nbsp; อายุ : <b id='age'></b> ปี &nbsp;&nbsp; HN : <b id='hn'></b> &nbsp;&nbsp; AN : <b id='an'></b> &nbsp;&nbsp; Admit ครั้งที่ : <b id='admit_no'></b></p>"
            ...
            , $("<div class='row'>"
                ...
                + "<div class='col-sm-7'><input class='input-sm' type='text' id='biographer' name='biographer' placeholder='ชื่อผู้ให้ประวัติ'/></div> "
                + "</div>"
                + "<div class='form-group col-lg-5'><label class='col-sm-3 control-label no-padding-right' for='relative'>เกี่ยวข้องเป็น </label>"
                + "<div class='col-sm-7'><input class='input-sm' type='text' id='relative' name='relative'  placeholder='ความเกี่ยวข้องกับผู้ป่วย' /></div> "
                + "</div>"
                + "</div>")
            ...
            , $("<div class='row form-group'>"
                + "<div class='col-lg-5 col-sm-12'><label class='col-lg-3 col-sm-3 control-label no-padding-left' for='tel1'>หมายเลขโทรศัพท์ 1</label>"
                + "<div class='row col-lg-5 col-sm-5 row'><input class='input-sm' type='text' id='tel1' name='tel1' value='' placeholder='หมายเลขโทรศัพท์' /></div> "
                + "</div>"
                + "<div class='col-lg-5 col-sm-12'><label class='col-lg-3 col-sm-3 control-label no-padding-right' for='relative1'>เกี่ยวข้องเป็น (1)</label>"
                + "<div class='col-lg-5 col-sm-5 row'><input class='input-sm' type='text' id='relative1' name='relative1'  value='' placeholder='ความเกี่ยวข้องกับผู้ป่วย' /></div> "
                + "</div>"
                + "</div>")
            , $("<div class='row form-group'>"
                + "<div class='col-lg-5 col-sm-12'><label class='col-lg-3 col-sm-3 control-label no-padding-left' for='tel2'>หมายเลขโทรศัพท์ 2</label>"
                + "<div class='row col-lg-5 col-sm-5 row'><input class='input-sm' type='text' id='tel2' name='tel2' placeholder='หมายเลขโทรศัพท์' /></div> "
                + "</div>"
                + "<div class='col-lg-5 col-sm-12'><label class='col-lg-3 col-sm-3 control-label no-padding-right' for='relative2'>เกี่ยวข้องเป็น (2)</label>"
                + "<div class='col-lg-5 col-sm-5 row'><input class='input-sm' type='text' id='relative2' name='relative2' placeholder='ความเกี่ยวข้องกับผู้ป่วย' /></div> "
                + "</div>"
                + "</div>")
                , $("<div class='hr'></div>")
            ...
            , $("<div class='form-group row'>"
                ...
                +"<label class= 'col-sm-1 col-lg-1 control-label no-padding-left' for= 'earmark'><b>ตำหนิ </b></label> "
            ...
            , $("<textarea name='CC' id='CC' class='form-control' placeholder='อาการสำคัญ (CC)'></textarea><br>")
            , $("<div class='row'><label class='col-sm-5 col-form-label'><b>ประวัติความเจ็บป่วยปัจจุบัน (PI) </b></label></div>")
            , $("<textarea name='HPI' id='HPI' class='form-control' placeholder='ประวัติความเจ็บป่วยปัจจุบัน (PI)'></textarea><br>")
            , $("<div class='row'><label class='col-sm-5 col-form-label'><b>ประวัติความเจ็บป่วยทางจิตเวชในอดีต </b></label></div>")
            , $("<textarea name='pmh' id='pmh' class='form-control' placeholder='ประวัติความเจ็บป่วยทางจิตเวชในอดีต'></textarea>"));
 
///////////////////////////Part 2
        
        $("#part2").empty().append($("<div class='row'><label class='col-lg-4 col-sm-6 col-form-label'><b>โรคประจำตัวหรืออาการทางกายในปัจจุบัน </b></label><div class='col-sm-2'><label><input class='ace' type='radio' name='disease_chk' value='N'checked required><span class='lbl'> ไม่มี</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='disease_chk' value='Y' required><span class='lbl'> มี</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='disease_chk' value='U' required><span class='lbl'> ไม่ทราบ</span></label></div></div>"
            ...
            , $("<div id='Hurt_yourself'>"
                ...
                + "<div class='form-group'><textarea name='plan_detial' id='plan_detial' class='form-control' placeholder='ระบุวิธีการ/ว.ด.ป.'></textarea></div>"
                ...
                + "</div><div class='form-group'><textarea name='action_detial' id='action_detial' class='form-control' placeholder='ระบุวิธีการ/ว.ด.ป.'></textarea></div>")
            
            , $("<div class='row'><label class='col-lg-4 col-sm-6 col-form-label'><b>คดีทั่วไป </b></label><div class='col-sm-2'><label><input class='ace' type='radio' name='lawsuit_chk' value='N'checked required><span class='lbl'> ไม่มี</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='lawsuit_chk' value='Y' required><span class='lbl'> มี</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='lawsuit_chk' value='U' required><span class='lbl'> ไม่ทราบ</span></label></div></div>")
            , $("<div class='form-group'><textarea name='lawsuit' id='lawsuit' class='form-control' placeholder='รายละเอียดคดี'></textarea></div>")
            , $("<div class='row'><label class='col-lg-4 col-sm-6 col-form-label'><b>บุคลิกภาพเดิม </b></label></div>")
            , $("<div class='form-group'><textarea name='personality' id='personality' class='form-control' placeholder='รายละเอียดบุคลิกภาพเดิม'></textarea></div>")
            , $("<div class='hr2'></div>")
            ,$("<div class='form-group row'><label class='col-lg-4 col-sm-6 col-form-label'><u><b> การประเมินสภาพร่างกายเบื้องต้น  </b></u></label></div>")
            , $("<div class='form-group row'><label class='col-sm-1 col-lg-1' style='text-align:right;'><b>รูปร่าง </b></label> <div class='col-lg-3'><select class='form-control form-control-sm select2' id='shape' name='shape' style='width: 100%' required></select></div>"
                + "<div class='row'><label class='col-sm-1 col-form-label' style='text-align:right;'><b>สีผิว </b></label> <div class='col-lg-3'><select class='form-control form-control-sm select2' id='skin_color' name='skin_color' style='width: 100%' required></select></div></div>")
            //, $("<p>")
            , $("<div class='row'><label class='col-lg-4 col-sm-6 col-form-label'><b>โรคผิวหนัง </b></label><div class='col-sm-2'><label><input class='ace' type='radio' name='scab_chk' value='N'checked required><span class='lbl'> ไม่มี</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='scab_chk' value='Y' required><span class='lbl'> มี</span></label></div></div>"
                ...
                + "<div class='form-group'><textarea name='detial_scab' id='detial_scab' class='form-control' placeholder='ลักษณะโรคผิวหนัง'></textarea></div><p></div>")
            , $("<div class='row'><label class='col-lg-4 col-sm-6 col-form-label'><b>อาการบวม </b></label><div class='col-sm-2'><label><input class='ace' type='radio' name='swelling_chk' value='N'checked required><span class='lbl'> ไม่มี</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='swelling_chk' value='Y' required><span class='lbl'> มี</span></label></div></div>"
                + "<div class='form-group'><textarea name='swelling' id='swelling' class='form-control' placeholder='ลักษณะอาการบวม'></textarea><p></div>")
            , $("<div class='form-group row'>"
                + "<label class='col-sm-2 col-lg-1 col-form-label' for='movement'><b>การเคลื่อนไหว</b></label>"
                + "<div class='col-sm-10 col-lg-11'><input class='input-sm col-lg-12 col-md-12 col-xs-12' type='text' id='movement' name='movement' placeholder='ลักษณะการเคลื่อนไหว' /></div> "
                + "</div>")
            , $("<div class='row'><label class='col-lg-4 col-sm-6 col-form-label'><b>ความพิการ </b></label><div class='col-sm-2'><label><input class='ace' type='radio' name='disabled_chk' value='N'checked required><span class='lbl'> ไม่มี</span></label></div><div class='col-sm-2'><label><input class='ace' type='radio' name='disabled_chk' value='Y' required><span class='lbl'> มี</span></label></div></div>"
                + "<div class='form-group'><textarea name='disabled' id='disabled' class='form-control' placeholder='ลักษณะความพิการ'></textarea></div>"));

...
$data2 = isset($_POST['data2'])?$_POST['data2']:(isset($_GET['data2'])?$_GET['data2']:'');
    $exe = ':hn';
    $sql="select smiv.smi4_id,smi.chk_1,smi1.smiv_result smi1_1,smi2.smiv_result smi1_2,smi3.smiv_result smi1_3,smi4.smiv_result smi1_4,smi5.smiv_result smi1_5,smi6.smiv_result smi1_6,smi7.smiv_result smi1_7,smi8.smiv_result smi1_8
    ...
    ,CASE WHEN smi.smiv_class= '1' THEN 'ดูแลต่อเนื่อง' ELSE 'ติดตามไนระบบ( HDC )' END smiv_class
        from patient p 
        ...
        left outer join marrystatus m on p.marrystatus=m.code 
				where smiv.hn=:hn GROUP BY smi.vn";
    $conn_DB->imp_sql($sql);

...
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2020-10-01' and '2020-10-31'))m10
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2020-11-01' and '2020-11-30'))m11
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2020-12-01' and '2020-12-31'))m12
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-01-01' and '2021-01-31'))m01
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-02-01' and '2021-02-28'))m02
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-03-01' and '2021-03-31'))m03
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-04-01' and '2021-04-30'))m04
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-05-01' and '2021-05-31'))m05
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-06-01' and '2021-06-30'))m06
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-07-01' and '2021-07-31'))m07
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-08-01' and '2021-08-31'))m08
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2021-09-01' and '2021-09-30'))m09
,(SELECT count(tf.cons_id) FROM jvl_transferBox tf WHERE tf.cons_id = cs.cons_id and (tf.send_date between '2020-10-01' and '2021-09-30'))total

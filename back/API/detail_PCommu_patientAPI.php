...
if(!empty($data2)){
    ...
    $sql="SELECT p.hn,p.pname,p.fname,p.lname,p.informaddr,p.cid,p.birthday,m.name as mrname,v.vn,v.pdx,v.dx0,v.dx1,v.dx2,v.dx3,v.dx4,v.dx5,w.name as ward
    from patient p 
    ...
    inner join jvl_progress_commu pc on pc.ipd_fr_id = fr.ipd_fr_id
    LEFT OUTER JOIN ward w on w.ward = a.ward
    left outer join marrystatus m on p.marrystatus=m.code 
    where pc.pc_id =:pc_id";
    $conn_DB->imp_sql($sql);
    $execute=array(':pc_id'=>$data);

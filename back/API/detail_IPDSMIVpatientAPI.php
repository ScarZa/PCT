...
$data2 = isset($_POST['data2'])?$_POST['data2']:(isset($_GET['data2'])?$_GET['data2']:'');
    ...
    ,o1.loginname as recorder
    ,CASE
    WHEN smi.confirm = 1 THEN 'ดูแลต่อเนื่อง'
    WHEN smi.confirm = 2 THEN 'ติดตามในระบบ HDC'
    WHEN smi.confirm = 3 THEN 'ไม่เป็นผู้ป่วย SMI-V'
    ELSE 'อยู่ระหว่างการพิจารณา'
    END confirm
    ,smi.comment,smi.confirm_comment
...
//for($i=0;$i<count($rslt);$i++){
    ...
    $series['an'] = isset($rslt['an'])?$rslt['an']:'';

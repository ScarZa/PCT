...
if(!empty($data2)){
    ...
    $sql="select p.hn,p.pname,p.fname,p.lname,p.informaddr,p.cid,p.birthday,v.age_y,m.name as mrname,v.vn,v.pdx,v.dx0,v.dx1,v.dx2,v.dx3,v.dx4,v.dx5,os.bmi,os.cc,os.hpi
    from patient p 
    LEFT OUTER JOIN vn_stat v ON v.hn=p.hn
    inner join opdscreen os on os.vn=v.vn

...
if(!empty($data2)){
    ...
    ,(SELECT o.name FROM jvl_transferBox t inner join opduser o on o.loginname = t.sender WHERE t.tB_id=:tB_id)sender_name
		,t.resend
		,(SELECT o.name FROM jvl_transferBox t inner join opduser o on o.doctorcode = t.resendname WHERE t.tB_id=:tB_id)resender_name
        from patient p 
